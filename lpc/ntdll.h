...
typedef struct _PORT_MESSAGE_WOW64
{
	...
	union
	{
		unsigned long long ClientViewSize;       // Size of section created by the sender (in bytes)
		ULONG  CallbackId;              // 
	};
...
#define InitializeMessageHeaderWOW64(ph, l, t)														\
{																									\
    ...
    ((PORT_MESSAGE_WOW64 *)ph)->ClientId.UniqueProcess = NULL;										\
    ((PORT_MESSAGE_WOW64 *)ph)->ClientId.UniqueThread  = NULL;										\
    ((PORT_MESSAGE_WOW64 *)ph)->MessageId              = 0;											\
    ((PORT_MESSAGE_WOW64 *)ph)->ClientViewSize         = 0;											\
}
#endif
